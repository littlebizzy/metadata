...
* [Plugin Homepage](https://www.littlebizzy.com/plugins/metadata)
* [Download Latest Version (ZIP)](https://github.com/littlebizzy/metadata/archive/1.0.0.zip)
...
### Defined Constants
    ...
    define('METADATA', true); // default = true
